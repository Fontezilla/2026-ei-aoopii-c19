...
import { ArrowUp, Download, Film, Image, Loader2, Music, X } from "lucide-react";
                ...
                <div className="mx-auto flex h-[calc(100vh-11rem)] min-h-145 max-w-6xl overflow-hidden rounded-3xl border border-yellow-400/30 bg-black/60 shadow-2xl shadow-yellow-500/5 backdrop-blur-xl">
                    <div className="flex w-full flex-col border-r border-yellow-400/20 md:w-[42%]">
                        ...
                        <div className="shrink-0 border-t border-yellow-400/20 p-4">
                            <div
                                className={`flex items-end gap-2 rounded-2xl border px-4 py-3 transition-colors ${inputDisabled ? "border-yellow-400/10 bg-white/2" : "border-yellow-400/30 bg-white/5"
                                    }`}
                            >
                                <textarea
                                    rows={1}
                                ...
                                <div className="flex flex-1 items-center justify-center">
                                    <div className="relative aspect-video w-full overflow-hidden rounded-2xl border border-yellow-400/20">
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                                            ...
                                            {hasAudio && audioSrc && <audio controls className="w-full px-4" src={audioSrc} />}
                                    ...
                                    {!gen && !hasImages && (
                                        <div className="flex flex-1 items-center justify-center">
                                            <span className="text-xs text-zinc-500">
                                                As imagens das cenas aparecerão aqui
                                            </span>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="flex flex-1 items-center justify-center">
                                    <div className="relative aspect-video w-full overflow-hidden rounded-2xl border border-yellow-400/20">
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                                            ...
                                            {!gen && <span className="text-xs text-zinc-500">O vídeo aparecerá aqui</span>}
                                        </div>
                                    </div>
                                </div>
                            )}
